...
//        initTwoType(context, attrs);//第二种初始化
    ...
    private void initOneType(Context context, AttributeSet attrs) {
        ...
        for (int i = 0 ; i<totalAttributes ;i++) {
            ...
            if (index == R.styleable.CustomNavigatorBar_leftImage){
                ...
                int titleBarBackgroundColor = typedArray.getColor(index, getResources().getColor(R.color.material_blue_grey_80));
    ...
    public void setTitleBulder(TitleBarBuilder builder) {
        if (builder != null) {
            setVisibility(VISIBLE);
            leftText.setText(builder.getLeftText());
            leftText.setTextSize(builder.getLeftTextSize());
            leftText.setTextColor(builder.getLeftTextColor());
            leftText.setVisibility(builder.getLeftTextVisibility());
            leftImage.setImageResource(builder.getLeftImageResource());
            leftImage.setVisibility(builder.getLeftImageVisibility());
            rightImage.setImageResource(builder.getRightImageResource());
            rightImage.setVisibility(builder.getRightImageVisibility());
            rightText.setText(builder.getRightText());
            rightText.setTextSize(builder.getRightTextSize());
            rightText.setTextColor(builder.getRightTextColor());
            rightText.setVisibility(builder.getRightTextVisibility());
            midText.setText(builder.getTitle());
            midText.setTextSize(builder.getTitleTextSize());
